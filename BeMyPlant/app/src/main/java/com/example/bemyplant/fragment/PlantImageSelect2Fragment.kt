...
class PlantImageSelect2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.nextButton.setOnClickListener {
            findNavController().navigate(R.id.action_plantImageSelect2Fragment_to_userImageSelect1Fragment)
        }
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PlantImageSelect2Fragment.
         */
